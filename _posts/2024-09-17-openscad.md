...
tags:
    ...
    - Programming
image:
  path: /assets/images/2026/09/openscad-card-light.jpg
  dark: /assets/images/2026/09/openscad-card-dark.jpg
  alt: "The official OpenSCAD logo"
---
...
![Screenshot of the OpenSCAD editor: sphere-creating code in a dark code panel on the left, with the rendered 3D preview of two spheres on the right]({{ site.baseurl }}/assets/images/2024/09/openscad_demo.png)
...
![The official OpenSCAD logo]({{ site.baseurl }}/assets/images/2024/09/OpenSCAD-logo.png){: width="400"}
...
![Screenshot of Vim showing the OpenSCAD logo model code on the left, with the rendered 3D sphere-and-cylinders model on the right]({{ site.baseurl }}/assets/images/2024/09/openscad_mymodel.png)
