...
![AI-generated image of a woman in an Indian sari with a birthday cake in the night sky under a full moon]({{ site.baseurl }}/assets/images/2024/02/e75c159a-69db-479c-92f5-ab1f19defea1.jpg){:w="400"}
...
![AI-generated image of an air traffic control tower with balloons and confetti in the sky]({{ site.baseurl }}/assets/images/2024/02/943502_Air-traffic-control-tower-with-planes-dropping-con_xl-1024-v1-0.png){:w="550"}
...
![AI-generated image of a birthday party scene styled after Minecraft]({{ site.baseurl }}/assets/images/2024/02/907271_birthday-party-in-minecraft-players_xl-1024-v1-0.png){:w="550"}
