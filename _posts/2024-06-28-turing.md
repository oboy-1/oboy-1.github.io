...
_Image from [Wikipedia](https://en.wikipedia.org/wiki/Turing_machine)_
...
_What we will be making in this blog post_
...
_Visualization of the Turing Machine_
...
Download the complete code [here]({{ site.baseurl }}/assets/images/turing.zip)!
