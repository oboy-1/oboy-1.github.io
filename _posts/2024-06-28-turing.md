...
image:
  path: /assets/images/2026/09/turing-card-light.jpg
  dark: /assets/images/2026/09/turing-card-dark.jpg
  alt: "A Turing machine tape of cells, some holding 0s and 1s, with the read/write head pointing at the current cell"
---

### What is a Turing Machine?

![Physical museum model of a Turing machine, with two paper tape reels on either side of a mechanical read-write head]({{ site.baseurl }}/assets/images/2024/06/turing_model.jpg)
...
![Terminal animation of the Turing machine's memory tape stepping through the binary-addition program]({{ site.baseurl }}/assets/images/2024/06/turing_demo.gif){:.light}
![Terminal animation of the Turing machine's memory tape stepping through the binary-addition program]({{ site.baseurl }}/assets/images/2024/06/turing_demo_dark.gif){:.dark}
...
![Terminal output of print_mem: a row of memory cell values numbered 0-19, with an arrow pointing to the current head position]({{ site.baseurl }}/assets/images/2024/06/turing_display.png){:.light}
![Terminal output of print_mem: a row of memory cell values numbered 0-19, with an arrow pointing to the current head position]({{ site.baseurl }}/assets/images/2024/06/turing_display_dark.png){:.dark}
...
![Sample state diagram with labeled circles for each state connected by directional arrows showing transitions]({{ site.baseurl }}/assets/images/2024/06/state_diagram.png){:.light width="500"}
![Sample state diagram with labeled circles for each state connected by directional arrows showing transitions]({{ site.baseurl }}/assets/images/2024/06/state_diagram_dark.png){:.dark width="500"}
