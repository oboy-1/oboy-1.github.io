...
![Sample email showing a bulleted list of article links from an RSS feed reader]({{ site.baseurl }}/assets/images/2024/06/sample_rss_light.png){:.light}
![Sample email showing a bulleted list of article links from an RSS feed reader]({{ site.baseurl }}/assets/images/2024/06/sample_rss_dark.png){:.dark}
...
![The standard orange RSS feed icon]({{ site.baseurl }}/assets/images/2024/06/rss_feed_logo.png)
...
![Screenshot of the Mutt email client's graphical interface]({{ site.baseurl }}/assets/images/2024/06/Mutt.jpg){: width="550"}
