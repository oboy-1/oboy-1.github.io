...
![Screenshot of learnGitBranching: a terminal on the left for typing git commands, with the current commit graph and the goal commit graph to match shown as diagrams on the right]({{ site.baseurl }}/assets/images/2024/04/Screen-Shot-2024-04-27-at-9.20.55-PM-1024x582.png)
...
![Screenshot of learnGitBranching's "Git Demonstration" lesson dialog, explaining commits alongside a live commit-graph visualization]({{ site.baseurl }}/assets/images/2024/04/Screen-Shot-2024-04-27-at-9.20.31-PM-1024x582.png)

![Screenshot of learnGitBranching's level-select menu, showing chapters like "Introduction Sequence," "Ramping Up," and "Moving Work Around" with numbered level buttons]({{ site.baseurl }}/assets/images/2024/04/Screen-Shot-2024-04-27-at-9.21.49-PM-1024x582.png)
